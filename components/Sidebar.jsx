...
const Sidebar = () => {
  ...
  return (
    ...
    >
      <div className="flex flex-col">
        <div className="flex items-center justify-between relative">
          <div className="flex items-center pl-1 gap-4">
            <div >
              <img src="https://skaps.com/wp-content/uploads/2023/02/SkapsLogo_300px-e1692974942849.png" style={{ height: 50, width: 50 }}></img>
            </div>
            {/* <LogoIcon /> */}
            <span
      ...
      <div className={`${getNavItemClasses({})} px-3 py-4`} onClick={() => {
        sendTOTheLogin()
      }}>
        <div style={{ width: "2.5rem" }}>
          <LogoutIcon />
